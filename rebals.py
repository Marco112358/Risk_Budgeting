...
pv_dfs = [port_val1, port_val2, port_val3, port_val4]
...
fees_dfs = [fees1, fees2, fees3, fees4]
...
port_rtns_dfs = [port_rtns1, port_rtns2, port_rtns3, port_rtns4]
